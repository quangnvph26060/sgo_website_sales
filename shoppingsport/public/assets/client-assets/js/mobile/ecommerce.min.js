(() => {
  function t(t) {
    var o = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 0,
      ...
      n =
        arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : "add";
    loadingBox("open");
  ...
  (() => {
    function t(t) {
      navigator.geolocation
        ? (loadingBox("open"),
          navigator.geolocation.getCurrentPosition(e, o, { timeout: 1e4 }))
        : alert_show("error", t);
    }
    function e(t) {
      ...
      console.log("Latitude: " + e),
        ...
        $.get(
          ...
          .done(function (t) {
            t.address ? (console.log(t.address), a(t)) : loadingBox("close");
          })
          .fail(function () {
            ...
            1 == t.status
              ? (t.province &&
                  ($("#customer_province_id").text(
                    t.province && t.province.name ? t.province.name : ""
                  ),
                  $('input[name="province_id"]').val(
                    t.province && t.province.id ? t.province.id : ""
                  )),
                t.district &&
                  ($("#customer_district_id").text(
                    t.district && t.district.name ? t.district.name : ""
                  ),
                  $('input[name="district_id"]').val(
                    t.district && t.district.id ? t.district.id : ""
                  )),
                t.district &&
                  t.district.id &&
    ...
    $.ajaxSetup({
      ...
      $(document).ready(function () {
        ...
        $("body").on("click", "#compare-close", function (t) {
          ...
          $("body").on("click", ".product-buttons__wishlist", function (t) {
            var o = $(this).data("id"),
              ...
              success: function (t) {
                alert_show(t.status, t.message),
                  "remove" == a &&
                    ...
                    $(".pagination").empty().append(t.pagination),
                    0 == t.count_product && window.location.reload()),
                  $(".wishlist_products_counter_number").text(t.count);
              },
              error: function (t) {
                alert_show("error", e);
              },
          ...
          $("body").on("click", "*[data-form] *[type=submit]", function (t) {
            ...
            validForm(a) &&
              ("ajax" == o.data("form")
                ? $.ajax({
                    ...
                    success: function (t) {
                      if ((loadingBox("close"), 1 == t.status)) {
                        if (
                          (o.find("input").val(""),
                          o.find("textarea").val(""),
                          alert_show("success", t.message),
                          ...
                          return (
                            $("#register_row").empty().change(),
                            $("#register_row").append(t.html).change(),
                            !1
                          );
                        if (t.hasOwnProperty("url"))
                          return void (window.location.href = t.url);
                        1 == o.data("append") &&
                          $.each(t.data, function (t, e) {
                            console.log(t, e),
                              o.find('input[name="'.concat(t, '"]')).val(e);
                          }),
                          1 == o.data("reload") &&
                            setTimeout(function () {
                        ...
                        (alert_show("error", t.message),
                        null != t.action && "login" == t.action)
                      )
                        return (
                          "notFound" == t.type_action
                            ? $('input[name="username"]').css(
                                "border-color",
                                "red"
                              )
                            : "errorAcount" == t.type_action &&
                              $(
                    ...
                    error: function (t) {
                      loadingBox("close"), alert_show("error", e);
                    },
                  })
          ...
          $("body").on("click", ".payment-guide_title", function (t) {
            t.preventDefault(),
              ...
              $(this).next(".payment-guide-content").slideToggle();
          }),
          $("body").on("click", ".btn-confirm-payment", function (t) {
            ...
            if (validForm(n, "input-field")) {
              ...
              var r = $(this).data("order-id"),
                ...
                c = o.find('textarea[name="g-recaptcha-response"]').val();
              form_data.append("file", i.files[0]),
                ...
                $.ajax({
                  ...
                  error: function (t) {
                    alert_show("error", e), loadingBox("close");
                  },
                });
            }
          }),
        ...
        $.ajax({
          ...
          success: function (t) {
            $("#show_compare").empty(),
              ...
              1 == t.status || alert_show((type = "error"), t.message);
          },
          error: function (t) {
            alert_show("error", errorMessage);
          },
