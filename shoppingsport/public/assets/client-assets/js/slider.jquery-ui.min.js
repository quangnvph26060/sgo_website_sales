                ...
                return (
                    o
                        ? this.length || "instance" !== a
                            ...
                            : (l = void 0)
                        : (h.length &&
                              (a = t.widget.extend.apply(null, [a].concat(h))),
                          this.each(function () {
                              var e = t.data(this, n);
                              e
            ...
            _classes: function (e) {
                function i(i, a) {
                    ...
                    for (h = 0; h < i.length; h++)
                        (o = n.classesElementLookup[i[h]] || t()),
                            (o = t(
                                e.add
                            ...
                            s.push(i[h]),
                            a && e.classes[i[h]] && s.push(e.classes[i[h]]);
                }
                var s = [],
                    n = this;
                return (
            ...
            _on: function (e, i, s) {
                ...
                "boolean" != typeof e && ((s = i), (i = e), (e = !1)),
                    ...
                    t.each(s, function (s, o) {
                        ...
                        "string" != typeof o &&
                            (h.guid = o.guid = o.guid || h.guid || t.guid++);
                        var l = s.match(/^([\w:-]*)\s*(.*)$/),
                            r = l[1] + a.eventNamespace,
                            u = l[2];
                        u ? n.on(r, u, h) : i.on(r, h);
                    });
            },
            _off: function (e, i) {
                (i =
