                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea required name="description" class="form-control" id="content" rows="10"
                                                cols="80">{{ $brand->content }}</textarea><br><br>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12" style="display: none">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="title_seo" name="title_seo" value="{{ $brand->title_seo  }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12" style="display: none">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="keyword_seo" name="keyword_seo" value="{{ $brand->keyword_seo  }}">
                                        </div>
                                    </div>
