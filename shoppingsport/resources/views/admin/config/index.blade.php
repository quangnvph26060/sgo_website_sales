                                ...
                                <form class="form-valide-with-icon" action="{{ route('admin.config.update') }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="tel" class="form-control" name="constant_hotline"
                                                placeholder="Điện thoại tư vấn 24/7"
                                                value="{{ $config->constant_hotline }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="url" class="form-control" name="website"
                                                placeholder="Trang web" value="{{ $config->website }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="url" class="form-control" name="instagram_url"
                                                placeholder="Liên kết Instagram" value="{{ $config->instagram_url }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group" style="text-align: center">
                                        <img id="profileImagebanner" style="width:150px; height:auto"
                                            src="{{ showImageStorage($config->banner) }}" alt="image banner"
                                            class="v">
                                    </div>
                                    ...
                                    <div class="input-group mb-3" style="justify-content: space-between">
                                        ...
                                        <div class="custom-file" style="text-align: end">
                                            <input type="file" class="custom-file-input" id="logo1"
                                                name="slider1">
                                    ...
                                    <div class="form-group" style="text-align: center">
                                        <img id="profileImagelogo1" style="width:150px; height:auto"
                                            src="{{ showImageStorage($config->slider1) }}"
                                    ...
                                    <div class="input-group mb-3" style="justify-content: space-between">
                                        ...
                                        <div class="custom-file" style="text-align: end">
                                            <input type="file" class="custom-file-input" id="logo2"
                                                name="slider2">
                                    ...
                                    <div class="input-group mb-3" style="justify-content: space-between">
                                        ...
                                        <div class="custom-file" style="text-align: end">
                                            <input type="file" class="custom-file-input" id="logo3"
                                                name="slider3">
