                    ...
                    <div class="card-body">
                        <div class="">
                            <div id="basic-datatables_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4">
                                <form method="POST" action="{{ route('admin.order.active', ['id' => $order->id]) }}"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select name="active" id="active" class="form-control" name="is_active"
                                                required>
                                                <option value="">Đang chờ xử lý</option>
                                                <option {{ $order->is_active == 1 ? 'selected' : '' }} value="1">Duyệt
                                                </option>
                                                <option {{ $order->is_active == 2 ? 'selected' : '' }} value="2">Không
                                                    duyệt</option>
