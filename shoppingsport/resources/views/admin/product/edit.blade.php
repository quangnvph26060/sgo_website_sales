                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group image-upload-container">
                                                ...
                                                <div class="custom-file mb-3">
                                                    <input type="file" class="custom-file-input" id="image-input"
                                                        name="new_images[]" multiple accept="image/*"
                                                    ...
                                                    <div class="row" id="image-preview-container"
                                                        ...
                                                        @foreach ($product->images as $image)
                                                            <div class="image-preview" data-image="{{ asset($image) }}">
                                                                <img src="{{ showImageStorage($image->image) }}"
                                                                    alt="Image">
                                                                <button type="button" class="remove-btn"
                                                                    onclick="removeOldImage(this, '{{ $image->id }}')">X</button>
                                                            </div>
                                                        @endforeach
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea required name="description_short" class="form-control" id="content" rows="10" cols="80"> {{ $product->content }}</textarea><br><br>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea required name="description" class="form-control" id="description" rows="10" cols="80">{{ $product->description }}</textarea><br><br>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="keyword_seo"
                                                    name="keyword_seo" value="{{ $product->keyword_seo }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea required name="description_seo" class="form-control" id="description_seo" rows="10" cols="80">{{ $product->keyword_seo }}"></textarea><br><br>
                                            </div>
                                        </div>
