            ...
            <div class="product-item__wrap">
                <div class="image">
                    <div class="product-buttons">
                        <p class="product-buttons__wishlist" data-id="{{ $product->id }}" data-type="add">
                        ...
                        <p class="product-buttons__compare"
                            onclick="addCompare('43', 'Ghế massage Oreni OR-520 Plus', 'https://thanhloisport.com/thumbnails/products/medium/wp-content/uploads/2022/02/oreni-or-520-plus-1.jpg', '0đ', '18')">
                        ...
                        <a class="product-buttons__quickview"
                            href="https://thanhloisport.com/ghe-massage-oreni-or-520-plus.html"
                    ...
                    <a class="image-link" href="https://thanhloisport.com/ghe-massage-oreni-or-520-plus.html"
                        aria-label="Ghế massage Oreni OR-520 Plus">
                        <img loading="lazy"
                            src="https://thanhloisport.com/thumbnails/products/medium/wp-content/uploads/2022/02/oreni-or-520-plus-1.jpg.webp"
                            alt="oreni-or-520-plus-1" title="Ghế massage Oreni OR-520 Plus" width="224px"
                            height="224px" />
                    </a>
                </div>
                <div class="content">
                    <div class="content-top">
                        <h3 class="content-top__title">
                            <a href="https://thanhloisport.com/ghe-massage-oreni-or-520-plus.html"
                        ...
                        <p class="btn btn-primary btn-add__cart d-none" data-id="{{$product->id}}">Thêm
                            giỏ hàng</p>
                    </div>
                    <div class="content-bottom">
                        <div class="content-bottom__wrap">
                            <ul class="desciption"></ul>
                            <p class="btn btn-primary btn-add__cart" data-id="{{$product->id}}">
                                Thêm giỏ hàng
                            </p>
                        </div>
                    </div>
