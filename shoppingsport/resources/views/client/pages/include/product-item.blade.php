        ...
        <div class="image">
            @if (!is_null($product->discount_id) && !is_null($product->discountValue))
                <div class="product-badges"><span
                        class="badge style-1 sale">{{ number_format($product->discountValue->value) }}%</span></div>
            @endif
                ...
                <p class="product-buttons__wishlist" data-id="{{ $product->id }}" data-type="add">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="20" height="20">
                        <path
                            ...
                            color="#000" font-family="sans-serif" font-weight="400" overflow="visible" fill="#000000"
